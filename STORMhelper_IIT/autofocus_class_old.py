...
class autofocus():
    ...
    def __init__(self):
        ...
        self.y0, self.y_bottom, self.y_top = 520, 520, 520
        self.x0, self.x_bottom, self.x_top = 685, 685, 685
        self.kernel = np.ones((10,10),np.uint8)
        self.radius = 400
        self.ang_range_deg = 120
        self.showlines=0
    ...
    def calc_radius(self):
        ...
        for idx in range (0,len(y_array)):
            ...
            xQ,yQ =  np.linspace(self.x0, x_array[idx], int(num)), np.linspace(self.y0, y_array[idx], int(num))
